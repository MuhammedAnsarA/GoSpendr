...
class SearchBloc extends Bloc<SearchEvent, SearchState> {
  ...
  FutureOr<void> _onLoadSearch(LoadSearch event, Emitter<SearchState> emit) {
    emit(const SearchLoaded());
  }

  FutureOr<void> _onSearchProduct(
      SearchProduct event, Emitter<SearchState> emit) {
  ...
  FutureOr<void> _onUpdateResults(
      UpdateResults event, Emitter<SearchState> emit) {}
